...
export default function CategoryCard({ category }: CategoryCardProps) {
  ...
  return (
    ...
    >
      <div className="relative aspect-[3/2] w-full overflow-hidden bg-section-alt">
        {imageUrl ? (
          <Image
            src={imageUrl}
            alt={category.name}
          ...
          <div className="flex h-full w-full items-center justify-center bg-section-alt">
      ...
      <div className="flex items-center justify-between px-4 py-3">
        <span className="font-body text-sm font-medium text-secondary transition-colors group-hover:text-gold">
          Explore Collection
        </span>
        <svg
          className="h-4 w-4 text-secondary transition-transform duration-200 group-hover:translate-x-1 group-hover:text-gold"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
