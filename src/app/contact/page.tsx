...
const localBusinessJsonLd = {
  ...
  geo: { '@type': 'GeoCoordinates', latitude: '22.4167', longitude: '88.3833' },
...
export default function ContactPage() {
  return (
    <>
      ...
      {/* Content — body mesh gradient shows on transparent areas */}
      <div className="py-14" style={{ background: '#EEF6FD' }}>
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-2">
            {/* Contact info */}
            <div className="flex flex-col gap-5">
              <h2 className="font-heading text-3xl font-light text-primary">Contact Details</h2>
              ...
              <a
                ...
                className="group flex min-h-[44px] items-start gap-4 p-4 transition-all duration-300 hover:shadow-lg"
                style={{
                  ...
                  borderRadius: '14px',
                  boxShadow: '0 4px 20px rgba(242,196,196,0.15)',
                }}
              >
                <div
                ...
                >
                  <WaIcon className="h-6 w-6 text-green-600" />
                </div>
                <div>
                  <p className="font-heading text-lg font-semibold text-primary transition-colors duration-300 group-hover:text-gold">
                    WhatsApp
                  </p>
                  <p className="font-body text-sm text-secondary">+91 93307 99407</p>
                  <p className="font-body mt-1 text-xs text-gold">Tap to open WhatsApp chat →</p>
                </div>
              </a>
            ...
            <div className="flex flex-col gap-6">
              <h2 className="font-heading text-3xl font-light text-primary">Find Us</h2>

              <div
                className="overflow-hidden"
                style={{ borderRadius: '16px', border: '1px solid rgba(255,255,255,0.5)', boxShadow: '0 8px 32px rgba(242,196,196,0.2)' }}
              >
                <iframe
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex min-h-[44px] items-center gap-2 font-body text-sm font-medium text-secondary transition-all duration-300 hover:text-gold"
                style={{
                  background: 'rgba(255,255,255,0.6)',
                  ...
                  padding: '10px 20px',
                  width: 'fit-content',
                  boxShadow: '0 4px 16px rgba(242,196,196,0.15)',
                }}
              >
              ...
              >
                ...
                <p className="font-body mb-5 text-sm text-secondary">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex min-h-[44px] items-center gap-2 font-body text-sm font-semibold text-white transition-colors duration-300 hover:bg-gold"
                  style={{ background: '#1A1208', borderRadius: '2px', padding: '12px 28px', letterSpacing: '1px' }}
                >
